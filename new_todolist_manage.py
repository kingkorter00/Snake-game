...
def main() :
    ...
    if not os.path.exists(file_path):
        ...
        with open ("name.txt", "w") as file:
            file.write(user_name) #append too would work file.append

    def print_active_tasks(file_name: str) -> list:
     '''A function that prints tasks from a file in the program folder'''
     try:
    ...
    while True:
        ...
        try:
         ...
         if option == 1:
            print(f'Input "x" if you don\'t want to add a task')
            ...
            # if file name does exist, make manipulatin to the list created upon intialization of the code
                ...
                if task_name != 'x':
                 ...
                 print(f"You have added {task_name} as a new task")
        ...
        #option that change name of task
            ...
            if os.path.exists('active.txt'):
                ...
                try:
                   ...
                   print(f'Input 0 incase you don\'t want to change the task name  ')
                   ...
                   if 0 <=  task_number < len(my_list) :
                       ...
                       print(f"Your new task {new_task} has been updated")
         ...
         #option that mark tasks as active and remove the tasks from active tasks, add them to completed list or completed file
            ...
            if os.path.exists('active.txt'):
                ...
                try:
                   print(f"Input 0 incase you dont want to mark a task as completed")
                   ...
                   if 0 <=  task_number2 < len(my_list) :
                       if os.path.exists('completed.txt'):
                          ...
                          print(f"Your task has been completed, print out completed tasks to see it")
        ...
        #option that deletes tasks from active file or list, and add them to deleted file or list
            ...
            if os.path.exists('active.txt'):
                ...
                try:
                   ...
                   print(f"Input 0 incase you dont want to mark a task as deleted")
                   task_number3 = int(input('What task ID do you want deleted ')) -1
                   ...
                   if 0 <=  task_number3 < len(my_list) :
                       if os.path.exists('deleted.txt'):
                          ...
                          print(f"Your task has been deleted, print out deleted tasks to see it")
